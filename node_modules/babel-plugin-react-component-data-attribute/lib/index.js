...
exports.default = babelPluginReactComponentDataAttribute;
...
function babelPluginReactComponentDataAttribute({ types: t }) {
  ...
  function shouldProcessPotentialComponent(path, name, state) {
    ...
    var _ref = state.opts || {},
        _ref$onlyRootComponen = _ref.onlyRootComponents;

    const onlyRootComponents = _ref$onlyRootComponen === undefined ? false : _ref$onlyRootComponen;
  ...
  const returnStatementVisitor = {
    ...
    CallExpression(path, { name, source }) {
      ...
      if (!path.get('callee.object').isIdentifier({ name: 'React' })) {
        return;
      }
